...
public class SshSftpScenario extends ScenarioTest {
    ...
    protected void initTarget() throws IOException {
        ...
        targetFileSystem = FileSystems.newFileSystem(URI.create("ssh+sftp://overthere@" + glassfish_ssh.getHostName() + "/?os=UNIX"), map);
